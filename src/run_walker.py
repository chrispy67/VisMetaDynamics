...
if __name__ == '__main__':
    ...
    # reweight_fes = fes(save_path='docs/images/reweight_fes.png')

    # I NEED TO FIND A WAY TO PUT THE PATH TO THESE IMAGES INTO summary_dict{}!
    # That is what app.py is expecting
    ...
    # summary_dict['rads_time_url'] = '/static/images/rads_time.png'
    # summary_dict['fes_url'] = '/static/images/reweight_fes.png'
